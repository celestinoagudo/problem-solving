...
public class PDFViewer {
	...
	public static void main(String[] args) {
		...
		h.add(1); h.add(3); h.add(1); h.add(3); h.add(1);
		h.add(4); h.add(1); h.add(3); h.add(2); h.add(5);
		h.add(5); h.add(5); h.add(5); h.add(5); h.add(5);
		h.add(5); h.add(5); h.add(5); h.add(5); h.add(5);
		h.add(5); h.add(5); h.add(5); h.add(5); h.add(5); h.add(5);
	...
	public static int designerPdfViewer(List<Integer> h, String word) {
		...
		h.forEach(height ->  {	
			int counter = 0;
			for(char current = 'a'; current <= 'z' && counter < h.size(); 
					++current, ++counter) {
